...
"jdbc:mysql://localhost:3306/bookshop?user=root&password=123456&useUnicode=true&useSSL=false&serverTimezone=GMT%2B8&characterEncoding=utf-8");  
      ...
      "jdbc:mysql://localhost:3306/bookshop?user=root&password=123456&useUnicode=true&useSSL=false&serverTimezone=GMT%2B8&characterEncoding=utf-8");  
	          ...
	          comboBox.setModel(new DefaultComboBoxModel(new String[] {"2019-4-22", "2019-4-23", "2019-4-24", "2019-4-25", "2019-4-26", "2019-4-27","2019-4-28","2019-4-29","2019-4-30","2019-5-1","2019-5-2"}));
	          comboBox.setBounds(175, 312, 102, 23);
	          contentPane.add(comboBox);
	          
	          JComboBox comboBox_1 = new JComboBox();
	          comboBox_1.setModel(new DefaultComboBoxModel(new String[] {"2019-4-23", "2019-4-24", "2019-4-25", "2019-4-26", "2019-4-27", "2019-4-28","2019-4-29","2019-4-30","2019-5-1","2019-5-2","2019-5-3","2019-5-4","2019-5-5","2019-5-6"}));
