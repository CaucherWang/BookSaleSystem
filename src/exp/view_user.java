...
"jdbc:mysql://localhost:3306/bookshop?user=root&password=123456&useUnicode=true&useSSL=false&serverTimezone=GMT%2B8&characterEncoding=utf-8");  
	          ...
	          table.setModel(new DefaultTableModel(
	          	...
	          	new String[] {
	          		"ID", "name", "password", "gender","age","salary/stocks","级别"
		      ...
		      for(int i = 1; i < 15; i ++)
	        	  model.addRow(new Object[]{a1[70+10*i],a2[140+20*i],a3[70 + 10*i], a4[70 + 10*i],a6[70 + 10*i],a5[70 + 10*i],a7[70 + 10*i]});
	  ...
	  "jdbc:mysql://localhost:3306/bookshop?user=root&password=123456&useUnicode=true&useSSL=false&serverTimezone=GMT%2B8&characterEncoding=utf-8");  
	  	          ...
	  	          while (rs.next()) {  
	  	        	  	...
	  	        	  	a6[a16]=rs.getString("age");
	  	        	  	a5[a15]=rs.getString("salary");
//	  	        	  	float sal = Float.parseFloat(a5[a15]);
//		        	  	if(sal < 1) a5[a15] = String.format("%.3f", sal*100000);
	                    a11+=10;
	                    a12+=20;
	                    a13+=10;
	                    a14+=10;
